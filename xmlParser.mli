...
(** Xml Light Parser
 ...
 While basic parsing functions can be used in the {!Xmll} module, this module
...
(** When parsing an Xml document from a file using the {!Xmll.parse_file}
 ...
 {!Xmll.File_not_found} if a DTD file is needed and prove enabled. To enable
...
(* internal usage only... *)
val _raises : (Xmll.error_msg -> Lexing.lexbuf -> exn) -> (string -> exn) -> (Dtd.parse_error_msg -> Lexing.lexbuf -> exn) -> unit
